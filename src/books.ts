...
export const BOOKS: Book[] = [
  {
    code: 'GEN',
    index: 1,
    names: { pt: 'Gênesis', en: 'Genesis' },
    abbrs: { pt: ['gn'], en: ['ge', 'gn'] },
  },
  {
    code: 'EXO',
    index: 2,
    names: { pt: 'Êxodo', en: 'Exodus' },
    abbrs: { pt: ['ex'], en: ['ex', 'exod'] },
  },
  {
    code: 'LEV',
    index: 3,
    names: { pt: 'Levítico', en: 'Leviticus' },
    abbrs: { pt: ['lv'], en: ['le', 'lv'] },
  },
  {
    code: 'NUM',
    index: 4,
    names: { pt: 'Números', en: 'Numbers' },
    abbrs: { pt: ['nm'], en: ['nu', 'nm'] },
  },
  {
    code: 'DEU',
    index: 5,
    names: { pt: 'Deuteronômio', en: 'Deuteronomy' },
    abbrs: { pt: ['dt'], en: ['de', 'dt', 'deut'] },
  },
  {
    code: 'JOS',
    index: 6,
    names: { pt: 'Josué', en: 'Joshua' },
    abbrs: { pt: ['js'], en: ['jsh'] },
  },
  {
    code: 'JDG',
    index: 7,
    names: { pt: 'Juízes', en: 'Judges' },
    abbrs: { pt: ['jz'], en: ['jdg', 'jg'] },
  },
  {
    code: 'RUT',
    index: 8,
    names: { pt: 'Rute', en: 'Ruth' },
    abbrs: { pt: ['rt'], en: ['ru', 'rth'] },
  },
  {
    code: '1SA',
    index: 9,
    names: { pt: '1 Samuel', en: '1 Samuel' },
    abbrs: { pt: ['1sm'], en: ['1s', '1sa', '1sam'] },
  },
  {
    code: '2SA',
    index: 10,
    names: { pt: '2 Samuel', en: '2 Samuel' },
    abbrs: { pt: ['2sm'], en: ['2s', '2sa', '2sam'] },
  },
  {
    code: '1KI',
    index: 11,
    names: { pt: '1 Reis', en: '1 Kings' },
    abbrs: { pt: ['1rs', '1re'], en: ['1k', '1ki', '1kgs'] },
  },
  {
    code: '2KI',
    index: 12,
    names: { pt: '2 Reis', en: '2 Kings' },
    abbrs: { pt: ['2rs', '2re'], en: ['2k', '2ki', '2kgs'] },
  },
  {
    code: '1CH',
    index: 13,
    names: { pt: '1 Crônicas', en: '1 Chronicles' },
    abbrs: { pt: ['1cr'], en: ['1ch', '1chr'] },
  },
  {
    code: '2CH',
    index: 14,
    names: { pt: '2 Crônicas', en: '2 Chronicles' },
    abbrs: { pt: ['2cr'], en: ['2ch', '2chr'] },
  },
  {
    code: 'EZR',
    index: 15,
    names: { pt: 'Esdras', en: 'Ezra' },
    abbrs: { pt: ['ed', 'esd'], en: [] },
  },
  {
    code: 'NEH',
    index: 16,
    names: { pt: 'Neemias', en: 'Nehemiah' },
    abbrs: { pt: ['ne'], en: ['ne'] },
  },
  {
    code: 'EST',
    index: 17,
    names: { pt: 'Ester', en: 'Esther' },
    abbrs: { pt: ['et'], en: ['es'] },
  },
  {
    code: 'JOB',
  ...
  },
  {
    code: 'PSA',
    index: 19,
    names: { pt: 'Salmos', en: 'Psalms' },
    abbrs: { pt: ['sl', 'sal'], en: ['ps', 'psa', 'psm'] },
  },
  {
    code: 'PRO',
    index: 20,
    names: { pt: 'Provérbios', en: 'Proverbs' },
    abbrs: { pt: ['pv'], en: ['pr'] },
  },
  {
    code: 'ECC',
    index: 21,
    names: { pt: 'Eclesiastes', en: 'Ecclesiastes' },
    abbrs: { pt: ['ec'], en: ['ec', 'qoh'] },
  },
  {
    code: 'SNG',
    index: 22,
    names: { pt: 'Cânticos', en: 'Song of Solomon' },
    abbrs: { pt: ['ct', 'cantares', 'canticos'], en: ['so', 'sos', 'song'] },
  },
  {
    code: 'ISA',
    index: 23,
    names: { pt: 'Isaías', en: 'Isaiah' },
    abbrs: { pt: ['is'], en: ['is'] },
  },
  {
    code: 'JER',
    index: 24,
    names: { pt: 'Jeremias', en: 'Jeremiah' },
    abbrs: { pt: ['jr'], en: ['je'] },
  },
  {
    code: 'LAM',
    index: 25,
    names: { pt: 'Lamentações de Jeremias', en: 'Lamentations' },
    abbrs: { pt: ['lm', 'lam'], en: ['la'] },
  },
  {
    code: 'EZK',
    index: 26,
    names: { pt: 'Ezequiel', en: 'Ezekiel' },
    abbrs: { pt: ['ez'], en: ['eze', 'ezk'] },
  },
  {
    code: 'DAN',
    index: 27,
    names: { pt: 'Daniel', en: 'Daniel' },
    abbrs: { pt: ['dn'], en: ['da', 'dn'] },
  },
  {
    code: 'HOS',
    index: 28,
    names: { pt: 'Oseias', en: 'Hosea' },
    abbrs: { pt: ['os'], en: ['ho'] },
  },
  {
    code: 'JOL',
    index: 29,
    names: { pt: 'Joel', en: 'Joel' },
    abbrs: { pt: ['jl'], en: ['jl'] },
  },
  {
    code: 'AMO',
    index: 30,
    names: { pt: 'Amós', en: 'Amos' },
    abbrs: { pt: ['am'], en: ['am'] },
  },
  {
    code: 'OBA',
    index: 31,
    names: { pt: 'Obadias', en: 'Obadiah' },
    abbrs: { pt: ['ob', 'abd'], en: ['ob'] },
  },
  {
    code: 'JON',
    index: 32,
    names: { pt: 'Jonas', en: 'Jonah' },
    abbrs: { pt: ['jn'], en: ['jnh'] },
  },
  {
    code: 'MIC',
    index: 33,
    names: { pt: 'Miqueias', en: 'Micah' },
    abbrs: { pt: ['mq'], en: ['mi', 'mic'] },
  },
  {
    code: 'NAM',
    index: 34,
    names: { pt: 'Naum', en: 'Nahum' },
    abbrs: { pt: ['na'], en: ['na'] },
  },
  {
    code: 'HAB',
    index: 35,
    names: { pt: 'Habacuque', en: 'Habakkuk' },
    abbrs: { pt: ['hc'], en: ['hb'] },
  },
  {
    code: 'ZEP',
    index: 36,
    names: { pt: 'Sofonias', en: 'Zephaniah' },
    abbrs: { pt: ['sf'], en: ['zep'] },
  },
  {
    code: 'HAG',
    index: 37,
    names: { pt: 'Ageu', en: 'Haggai' },
    abbrs: { pt: ['ag'], en: ['hg', 'hag'] },
  },
  {
    code: 'ZEC',
    index: 38,
    names: { pt: 'Zacarias', en: 'Zechariah' },
    abbrs: { pt: ['zc'], en: ['zec'] },
  },
  {
    code: 'MAL',
    index: 39,
    names: { pt: 'Malaquias', en: 'Malachi' },
    abbrs: { pt: ['ml'], en: ['mal'] },
  },
  {
    code: 'MAT',
    index: 40,
    names: { pt: 'Mateus', en: 'Matthew' },
    abbrs: { pt: ['mt'], en: ['mt', 'mat'] },
  },
  {
    code: 'MRK',
    index: 41,
    names: { pt: 'Marcos', en: 'Mark' },
    abbrs: { pt: ['mc'], en: ['mk', 'mr'] },
  },
  {
    code: 'LUK',
    index: 42,
    names: { pt: 'Lucas', en: 'Luke' },
    abbrs: { pt: ['lc'], en: ['lk', 'lu'] },
  },
  {
    code: 'JHN',
    index: 43,
    names: { pt: 'João', en: 'John' },
    abbrs: { pt: ['jo'], en: ['jn', 'jhn'] },
  },
  {
    code: 'ACT',
    index: 44,
    names: { pt: 'Atos', en: 'Acts' },
    abbrs: { pt: ['at'], en: ['ac'] },
  },
  {
    code: 'ROM',
    index: 45,
    names: { pt: 'Romanos', en: 'Romans' },
    abbrs: { pt: ['rm'], en: ['ro'] },
  },
  {
    code: '1CO',
    index: 46,
    names: { pt: '1 Coríntios', en: '1 Corinthians' },
    abbrs: { pt: ['1co'], en: ['1co'] },
  },
  {
    code: '2CO',
    index: 47,
    names: { pt: '2 Coríntios', en: '2 Corinthians' },
    abbrs: { pt: ['2co'], en: ['2co'] },
  },
  {
    code: 'GAL',
    index: 48,
    names: { pt: 'Gálatas', en: 'Galatians' },
    abbrs: { pt: ['gl'], en: ['ga'] },
  },
  {
    code: 'EPH',
    index: 49,
    names: { pt: 'Efésios', en: 'Ephesians' },
    abbrs: { pt: ['ef'], en: ['ep', 'eph'] },
  },
  {
    code: 'PHP',
    index: 50,
    names: { pt: 'Filipenses', en: 'Philippians' },
    abbrs: { pt: ['fp'], en: ['php', 'phil'] },
  },
  {
    code: 'COL',
    index: 51,
    names: { pt: 'Colossenses', en: 'Colossians' },
    abbrs: { pt: ['cl'], en: [] },
  },
  {
    code: '1TH',
    index: 52,
    names: { pt: '1 Tessalonicenses', en: '1 Thessalonians' },
    abbrs: { pt: ['1ts'], en: ['1th'] },
  },
  {
    code: '2TH',
    index: 53,
    names: { pt: '2 Tessalonicenses', en: '2 Thessalonians' },
    abbrs: { pt: ['2ts'], en: ['2th'] },
  },
  {
    code: '1TI',
    index: 54,
    names: { pt: '1 Timóteo', en: '1 Timothy' },
    abbrs: { pt: ['1tm'], en: ['1ti'] },
  },
  {
    code: '2TI',
    index: 55,
    names: { pt: '2 Timóteo', en: '2 Timothy' },
    abbrs: { pt: ['2tm'], en: ['2ti'] },
  },
  {
    code: 'TIT',
    index: 56,
    names: { pt: 'Tito', en: 'Titus' },
    abbrs: { pt: ['tt'], en: ['ti'] },
  },
  {
    code: 'PHM',
    index: 57,
    names: { pt: 'Filemom', en: 'Philemon' },
    abbrs: { pt: ['fm', 'flm'], en: ['phm', 'phlm'] },
  },
  {
    code: 'HEB',
    index: 58,
    names: { pt: 'Hebreus', en: 'Hebrews' },
    abbrs: { pt: ['hb'], en: ['heb'] },
  },
  {
    code: 'JAS',
    index: 59,
    names: { pt: 'Tiago', en: 'James' },
    abbrs: { pt: ['tg'], en: ['jas', 'jm'] },
  },
  {
    code: '1PE',
    index: 60,
    names: { pt: '1 Pedro', en: '1 Peter' },
    abbrs: { pt: ['1pe', '1pd'], en: ['1pe', '1pt'] },
  },
  {
    code: '2PE',
    index: 61,
    names: { pt: '2 Pedro', en: '2 Peter' },
    abbrs: { pt: ['2pe', '2pd'], en: ['2pe', '2pt'] },
  },
  {
    code: '1JN',
    index: 62,
    names: { pt: '1 João', en: '1 John' },
    abbrs: { pt: ['1jo'], en: ['1jn'] },
  },
  {
    code: '2JN',
    index: 63,
    names: { pt: '2 João', en: '2 John' },
    abbrs: { pt: ['2jo'], en: ['2jn'] },
  },
  {
    code: '3JN',
    index: 64,
    names: { pt: '3 João', en: '3 John' },
    abbrs: { pt: ['3jo'], en: ['3jn'] },
  },
  {
    code: 'JUD',
    index: 65,
    names: { pt: 'Judas', en: 'Jude' },
    abbrs: { pt: ['jd'], en: ['jd'] },
  },
  {
    code: 'REV',
    index: 66,
    names: { pt: 'Apocalipse', en: 'Revelation' },
    abbrs: { pt: ['ap'], en: ['re', 'rv'] },
  },
];
...
function rankIn(
  ...
  const abbr = (test: (a: string) => boolean): string | null =>
    abbrs.find(test) ?? null;
  ...
  if (fold(name).startsWith(folded))
    return { rank: Rank.NamePrefix, abbr: null };
...
export function matchBooks(
  ...
  return matches
    .sort((a, b) => a.rank - b.rank || a.book.index - b.book.index)
    .slice(0, limit);
}
...
export const CATEGORIES: Section[] = [
  ...
  { from: 44, to: 44, names: { pt: 'Histórico', en: 'History' } },
  {
    from: 45,
    to: 57,
    names: { pt: 'Cartas Paulinas', en: 'Pauline Epistles' },
  },
