...
export type Row = RefSuggestion | HintSuggestion;
...
export interface RowContext {
  /** What was typed after the `@`, the `!` of an embed included. */
  query: string;
...
export class ReferenceRows {
   ...
   */
  async getSuggestions(ctx: RowContext): Promise<Row[]> {
